...
PAGES = [
    {
        ...
        "content": (
            ...
            "<p>ChuckysCarnage is an independent technology news site covering science, space, AI, "
            "gadgets, phones, software, security, and health research. Each post is written from the "
            "day's publicly available reporting, links back to the original sources, and adds an "
            "original analysis of what the news actually means.</p>\n"
            "<h2>How articles are made</h2>\n"
            "<p>Every article starts with the reporting published by the outlets and organizations "
            "linked in the post. The facts are summarized and checked against those sources, and the "
            "analysis section separates what is confirmed from what is still open. Corrections are "
            "published when we get something wrong. Details on sourcing and corrections are in the "
            "<a href=\"/editorial-policy\">Editorial Policy</a>, and how automation is used is "
            "described in the <a href=\"/ai-policy\">AI Usage Policy</a>.</p>\n"
            "<h2>What to expect</h2>\n"
            "<ul>\n"
            "<li>Original analysis, not rewritten press releases.</li>\n"
            "<li>Every claim traceable to a linked source.</li>\n"
            "<li>Plain language about complex topics.</li>\n"
            "<li>Corrections handled openly through the <a href=\"/contact\">Contact</a> page.</li>\n"
            "</ul>\n"
            "<p>Found something wrong, or have a story worth covering? "
    ...
    },
    {
        ...
        "title": "Contact",
        "content": (
            "<p>Questions, corrections, story tips, or business inquiries — we read everything sent "
            "to <a href=\"mailto:ChuckysCarnage@gmail.com\">ChuckysCarnage@gmail.com</a> and aim to "
            "reply within a couple of days.</p>\n"
            "<h2>Send a message</h2>\n"
            "<form id=\"contact-form\" onsubmit=\"return buildMailto()\">\n"
            "<p><label for=\"cf-name\">Your name</label><br>\n"
            "<input type=\"text\" id=\"cf-name\" name=\"name\" required></p>\n"
            "<p><label for=\"cf-topic\">Topic</label><br>\n"
            ...
            "</select></p>\n"
            "<p><label for=\"cf-message\">Message</label><br>\n"
            "<textarea id=\"cf-message\" name=\"message\" rows=\"6\" cols=\"50\" required></textarea></p>\n"
            "<p><input type=\"submit\" value=\"Send by email\"></p>\n"
            "</form>\n"
            "<script>\n"
            ...
            "  var subject = encodeURIComponent('[ChuckysCarnage] ' + topic);\n"
            "  var body = encodeURIComponent(message + '\\n\\n— ' + name);\n"
            "  window.location.href = 'mailto:ChuckysCarnage@gmail.com?subject=' + subject + '&body=' + body;\n"
            "  return false;\n"
            "}\n"
            "</script>\n"
            "<h2>Corrections</h2>\n"
            "<p>Spot an error? Tell us and we will review it promptly and publish a correction where "
            "needed. See the <a href=\"/editorial-policy\">Editorial Policy</a> for how we handle "
            "accuracy.</p>"
        ),
    },
    {
    ...
    },
    {
        ...
        "content": (
            "<p>ChuckysCarnage publishes analysis of technology, science, space, and health news on "
            "this site. New posts appear here first.</p>\n"
            "<h2>Ways to follow</h2>\n"
            "<ul>\n"
            "<li>Bookmark the site or subscribe to the "
            "<a href=\"/feed/\">RSS feed</a>.</li>\n"
            "<li>Comment directly on posts — discussion happens in the comments.</li>\n"
            "<li>Contact us anytime through the <a href=\"/contact\">Contact</a> page.</li>\n"
            "</ul>\n"
            "<h2>Community guidelines</h2>\n"
            "<p>We welcome thoughtful discussion and encourage comments that are respectful, informed, "
            "and grounded in evidence rather than hype.</p>"
        ),
    },
]
